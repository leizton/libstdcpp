...
cstdio\nfunctexcept.h\n__gnu_cxxGNU extensions for public use. \nnumeric\n__gnu_cxx::power_Tp power(_Tp __x, _Integer __n, _MonoidOperation __monoid_op)Definition: ext/numeric:113\nstd::operator &bitset< _Nb > operator &(const bitset< _Nb > &__x, const bitset< _Nb > &__y) noexceptGlobal bitwise operations on bitsets. Definition: bitset:1429\nalgorithm\nstd::min_GLIBCXX14_CONSTEXPR const _Tp & min(const _Tp &, const _Tp &)This does what you think it does. Definition: stl_algobase.h:195\n__gnu_cxx::lexicographical_compare_3wayint lexicographical_compare_3way(_InputIterator1 __first1, _InputIterator1 __last1, _InputIterator2 __first2, _InputIterator2 __last2)memcmp on steroids. Definition: ext/algorithm:201\nstd::_Destroyvoid _Destroy(_Tp *__pointer)Definition: stl_construct.h:97\nstd::uninitialized_copy_n_ForwardIterator uninitialized_copy_n(_InputIterator __first, _Size __n, _ForwardIterator __result)Copies the range [first,first+n) into result. Definition: stl_uninitialized.h:812\nostream\nstd::ios_base::leftstatic const fmtflags leftAdds fill characters on the right (final positions) of certain generated output. (I.e., the thing you print is flush left.) Definition: ios_base.h:344\nstd::max_GLIBCXX14_CONSTEXPR const _Tp & max(const _Tp &, const _Tp &)This does what you think it does. Definition: stl_algobase.h:219\nstd::basic_ostreamTemplate class basic_ostream. Definition: iosfwd:86\nmemory\n
