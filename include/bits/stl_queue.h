...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  */
  ...
  class queue {
   ...
   public:
    ...
    decltype(auto)
    emplace(_Args&&... __args) { return c.emplace_back(std::forward<_Args>(__args)...); }
#else
    template <typename... _Args>
    void
    emplace(_Args&&... __args) { c.emplace_back(std::forward<_Args>(__args)...); }
#endif
#endif
  ...
  */
  ...
  inline bool
  operator==(const queue<_Tp, _Seq>& __x, const queue<_Tp, _Seq>& __y) { return __x.c == __y.c; }
  ...
  */
  ...
  template <typename _Tp, typename _Seq>
  inline bool
  operator!=(const queue<_Tp, _Seq>& __x, const queue<_Tp, _Seq>& __y) { return !(__x == __y); }

  /// Based on operator<
  template <typename _Tp, typename _Seq>
  inline bool
  operator>(const queue<_Tp, _Seq>& __x, const queue<_Tp, _Seq>& __y) { return __y < __x; }
  ...
  class priority_queue {
   ...
   public:
    ...
    explicit priority_queue(const _Compare& __x = _Compare(),
        ...
        : c(__s), comp(__x) { std::make_heap(c.begin(), c.end(), comp); }
#else
    ...
    explicit priority_queue(const _Compare& __x, _Sequence&& __s = _Sequence())
        : c(std::move(__s)), comp(__x) { std::make_heap(c.begin(), c.end(), comp); }
