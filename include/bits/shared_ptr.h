...
#pragma GCC diagnostic pop
  ...
  public:
    ...
    shared_ptr<_Tp>
    lock() const noexcept { return shared_ptr<_Tp>(*this, std::nothrow); }
  };
  ...
  protected:
    ...
    operator=(const enable_shared_from_this&) noexcept { return *this; }
...
#define __cpp_lib_enable_shared_from_this 201603
  ...
  private:
    ...
    __enable_shared_from_this_base(const __shared_count<>&,
                                   const enable_shared_from_this* __p) { return __p; }
