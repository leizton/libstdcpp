...
#define __cpp_lib_is_final 201402L
  ...
  struct __is_default_constructible_safe<_Tp, true>
      : public __and_<__is_array_known_bounds<_Tp>,
                      __is_default_constructible_atom<typename remove_all_extents<_Tp>::type>>
  {
  };
  ...
  struct __is_nt_default_constructible_impl<_Tp, true>
      : public __and_<__is_array_known_bounds<_Tp>,
                      __is_nt_default_constructible_atom<typename remove_all_extents<_Tp>::type>>
  {
  };
...
#define __cpp_lib_transformation_trait_aliases 201304
  ...
  */
  ...
  {
    template <typename _Tp, typename _Up>
    static __success_type<typename decay<decltype(true ? std::declval<_Tp>()
                                                       : std::declval<_Up>())>::type>
    _S_test(int);
...
#define _GLIBCXX_HAS_NESTED_TYPE(_NTYPE)                                                                                                         \
  \ template <typename _Tp, typename = __void_t<>>                            \ struct __has_##_NTYPE                                          \ \
      : false_type                                                   \ {};                                                                       \
  \ template <typename _Tp>                                           \ struct __has_##_NTYPE<_Tp, __void_t<typename _Tp::_NTYPE>>             \ \
      : true_type                                                            \                                                                   \
  {                                                                                                                                              \
  };
